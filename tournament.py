...
def swissPairings():
    ...
    """
    pairings = []
    player_order = playerStandings()
    number_players = len(player_order)
    for i in range(1, len(player_order), 2):
        first_player = player_order[i-1]
        second_player = player_order[i]
